'use client';
// Site.jsx — ProDesk marketing site (Next.js client component)
...
import { PersonaCtx, usePersona } from "./PersonaContext";
import MiniMock from "./MiniMock";
import FoundingPartners from "./Partners";
import { useTweaks, TweaksPanel, TweakSection, TweakSlider, TweakToggle, TweakRadio, TweakSelect, TweakText, TweakNumber, TweakColor, TweakButton } from "./TweaksPanel";

// Icon — uses the SVG sprite at /public/assets/icons.svg
...
// PersonaCtx + usePersona imported from ./PersonaContext.jsx
...
const HERO_COPY = {
  none: {
    ...
    h: <>Your business runs on <em className="brand">a hundred tabs.</em><br/>Now it runs on one.</>,
    lede: "ProDesk is the operations dashboard that consolidates every agency, document, subscription and payment into a single workspace — so the people running the business stop being the office manager of it.",
  ...
  brand: {
    eyebrow: "One platform · Every tool · Free for brands",
    h: <>Grow your brand fast; with <em className="brand">every agency</em> in one super app.</>,
    lede: "ProDesk is the operations dashboard that runs every agency, document and dollar from one tab — so you get back to actually building the thing you're most passionate about. Free for brands, forever.",
  ...
  agency: {
    ...
    meta: "5% lifetime revenue share · Auto-paid monthly · Transferable on sale",
    proof: [
      { n: "5", u: "%", l: "lifetime share on every client you bring" },
      { n: "$184", u: "k", l: "average partner agency, year-one residual" },
...
function HeroFloats({ persona }) {
  const map = {
    ...
    agency: [
      { side: "left",  ic: "i-trend-up", lbl: "Lifetime residual",        val: "$48,200 / mo · 27 clients" },
...
const STEPS_COPY = {
  ...
  agency: {
    ...
    list: [
      ...
      { n: "03", title: "Win + earn",                  body: "Win new work from brands already on platform. Earn 5% of everything your referred clients spend, across any service, for life.", glyph: "✓" },
    ],
  },
  contractor: {
...
const TESTIMONIAL_SETS = {
  ...
  none: [
    ...
    },
    {
      ...
      role: 'Designer & content producer', sub: 'Freelance · Brand & event',
  ...
  contractor: [
    ...
    },
    {
      ...
      role: 'Technical & customer support agent', sub: 'Freelance · Support specialist',
      type: 'Contractor', accent: 'amber', portrait: PORTRAITS.warm,
      photo: '/assets/people/venji.jpeg',
      quote: "Agencies invite me into their ProDesk and I see exactly what the client needs — scope, deadlines, who approves it. I'm not chasing context across three apps or guessing what's in scope. The work is there, I do it, I get paid.",
      outcome: 'Plugged straight into agency workflows — no chasing context',
    },
    {
      id: 'contractor-chloe', name: 'Chloe', initials: 'Ch',
      role: 'Digital marketing specialist', sub: 'Freelance · Digital marketing',
      type: 'Contractor', accent: 'sky', portrait: PORTRAITS.sand,
      photo: '/assets/people/chloe.jpeg',
      quote: "Once I accept a job, the deliverables, deadlines and approver are right there in the brief. No 'just hop on a call to align' — I do the work, I send it, it gets approved, I get paid. The whole thing takes the friction out of freelancing.",
...
// ---- Replaces (universal) ----
const REPLACES = [
  { cat: "Proposals",          name: "PandaDoc",    glyph: "✎", note: "Proposals built from your catalogue. Sign + pay in one click." },
  { cat: "Sales CRM",          name: "Pipedrive",   glyph: "◉", note: "Pipeline, deal stages, follow-ups — purpose-built for agencies." },
  { cat: "Marketplace",        name: "Fiverr·Upwork",glyph: "▦", note: "Vetted agencies, not anonymous gig workers. Discipline-exclusive." },
  { cat: "Project management", name: "Asana·Monday",glyph: "▤", note: "Kanban your client can see. Briefs, comments, approvals, payouts." },
  { cat: "Client portal",      name: "Moxo·Copilot",glyph: "▣", note: "Branded portal per agency. Your logo, your domain, our engine." },
  { cat: "Payments",           name: "Stripe·invoicing",glyph:"$", note: "Take payment inside the proposal. No bouncing to checkout pages." },
  { cat: "Shopping cart",      name: "Shopify·WooCommerce",glyph:"⌘", note: "Sell physical, digital, services or subscriptions from one catalogue." },
  { cat: "Recurring billing",  name: "ChargeBee·Stripe Billing",glyph:"⟳", note: "Subscriptions tracked in one tab. Brands always know what's renewing." },
  { cat: "File storage",       name: "Dropbox·WeTransfer",glyph:"▱", note: "Document Locker per brand. Latest approved version, accessible to your team." },
  { cat: "Tasks & to-dos",     name: "Todoist·Things",glyph:"✓", note: "Tasks live on the project. Stage moves, payments fire automatically." },
  { cat: "Team chat",          name: "Slack·Moxo",  glyph: "✻", note: "Brand-scoped chat across every agency on the job. One thread, always." },
  { cat: "Affiliate program",  name: "PartnerStack·Rewardful",glyph:"✦", note: "Built-in. Bring a client, earn a share for life." },
];
      ...
      <div className="wrap">
        <div className="calc-shell">
          <div className="calc-copy">
            <span className="eyebrow-line" style={{color: 'rgba(244,241,232,0.6)'}}>
              <span className="dot" />The revenue model
            </span>
            <h2 style={{color: 'var(--paper)'}}>
              The model that <em className="brand" style={{color: 'var(--volt)'}}>rewards</em> loyalty.
            </h2>
...
const COMPARE_SETS = {
  none: {
    ...
    rows: [
      { row: "Where contracts and briefs live",       us: "One Document Locker",              them: "Inbox + Dropbox + Drive" },
      { row: "Subscription renewals",                 us: "One view, one cancel button",      them: "Six portals, one nasty surprise" },
      { row: "Paying for work",                       us: "Full or 12 / 26 / 52 weeks",       them: "All up front, every time" },
      { row: "Onboarding a new partner",              us: "They populate your hub for you",   them: "Brief docs, calls, follow-ups" },
      { row: "Knowing the real spend",                us: "By agency, category, month",       them: "Ask the bookkeeper" },
      { row: "What happens if a partner leaves",      us: "Your data stays. Yours.",          them: "Email begging for files" },
    ],
  },
  brand: {
    h: <>The <em className="brand">old</em> way vs. ProDesk.</>,
  ...
  agency: {
    ...
    rows: [
      { row: "What happens after a client engagement",  us: "5% of everything, forever",        them: "Hope they call you next year" },
      ...
      { row: "Selling client off",                      us: "Residual transfers with the sale", them: "Goodwill, on a handshake" },
  ...
  const tiers = [
    {
      ...
      features: [
        ...
        "Only pay for services or products you want",
        "100's of free templates and resources",
        "Unlimited Staff Access",
        "Unlimited Agencies",
        "Unlimited Project Tracking",
        "Tasks Functionality",
        "12 / 26 / 52 week payment options",
      ],
    },
    {
      id: "agency",
      name: "Agency",
      price: 0,
      per: "free + 5% revenue share",
      desc: "For agencies and professional service firms. Earn commissions on every client you bring.",
    ...
    },
    {
      ...
      desc: "For freelancers and specialists. Track projects, revisions and get paid faster than ever before.",
      cta: "Find work on ProDesk",
      tag: null,
      features: [
        "Get Paid on Autopilot",
        "Track Tasks & Projects",
        "Work for Unlimited Agencies",
...
const FAQ_SETS = {
  none: [
    ...
    { q: "Is it free?", a: "Free for brands, forever. Free for agencies — they earn a 5% lifetime share on every brand they refer. Free for contractors, with no platform cut. ProDesk earns from the transaction layer, not the seats." },
  ...
  agency: [
    { q: "What exactly is the 5% revenue share?", a: "When you refer a brand to ProDesk, your agency earns 5% of everything that brand ever spends on the platform — with any agency, on any service, for life. Paid monthly, automatically." },
    ...
    { q: "What happens if I sell the agency?", a: "The residual transfers with the sale. Your client book is now a real, valued asset on your balance sheet — exactly as it always should have been." },
...
const CTA_COPY = {
  none: {
    h: <>Everything <em>clicks.</em><br />When it's all in one place.</>,
  ...
  brand: {
    h: <>Everything <em>clicks.</em><br />Free for brands.</>,
  ...
  agency: {
    h: <>Everything <em>clicks.</em><br />And keeps paying.</>,
    ...
    meta: "5% lifetime share · Auto-paid · Transferable on sale",
  },
  contractor: {
    h: <>Everything <em>clicks.</em><br />And gets paid.</>,
        ...
        <div className="grid">
          ...
          <div className="col">
            ...
            <ul>
              ...
              <li><a href="#">info@prodesk.com</a></li>
            </ul>
          </div>
        </div>
        <div className="legal">
